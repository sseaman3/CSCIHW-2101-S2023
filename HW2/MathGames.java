...
public class MathGames {
 ...
 public char grade(double percent){
 ...
 public double tip(double bill, double people, double percent){
     double tip = (bill * (percent/100))/people;
     double total = Math.ceil(tip);
